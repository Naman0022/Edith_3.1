...
__all__ = [
    ...
    'DISPID_SLPSymbolic', 'DISPID_SPRulesItem',
    'DISPID_SPIGetDisplayAttributes',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechAudioBufferInfo',
    'DISPID_SPELexicalForm', 'DISPID_SVVoice',
    'SDA_Consume_Leading_Spaces', 'SPPHRASE', 'SPSNotOverriden',
    'DISPID_SpeechVoiceEvent', 'ISpeechVoice',
    'DISPID_SpeechPhraseElement', 'DISPID_SAVolume',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SOTIsUISupported',
    'eLEXTYPE_PRIVATE15', 'SPLO_STATIC',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpVoice', 'SPAS_RUN',
    'SRAExport', 'DISPID_SPRNumberOfElements',
    'DISPID_SDKGetStringValue', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechPhraseProperties', 'SDTDisplayText',
    'SpeechFormatType', 'SECFEmulateResult',
    'SGLexicalNoSpecialChars', 'SPEI_RESERVED5', 'SPGRAMMARSTATE',
    'DISPID_SVSLastResult', 'eLEXTYPE_PRIVATE2',
    'IEnumSpObjectTokens', 'DISPID_SRCESoundStart', 'SBOPause',
    'DISPID_SGRId', 'SPEI_SOUND_START', 'DISPID_SVSpeakStream',
    'DISPID_SGRsCommitAndSave', 'DISPID_SPEPronunciation',
    'DISPID_SRIsUISupported', 'DISPID_SOTCSetId', 'SPEI_SOUND_END',
    'SpPhoneConverter', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SDKDeleteValue', 'DISPID_SRGCmdLoadFromFile',
    'SPSTREAMFORMATTYPE', 'SREBookmark', 'DISPIDSPTSI_ActiveOffset',
    'SSTTTextBuffer', 'DISPID_SMSADeviceId', 'SVP_17',
    'DISPID_SRRGetXMLErrorInfo', 'eLEXTYPE_PRIVATE9', 'SPPS_LMA',
    'SVSFNLPSpeakPunc', 'DISPID_SLGenerationId', 'SPSHORTCUTPAIRLIST',
    'DISPID_SOTCreateInstance', 'DISPID_SDKSetBinaryValue',
    'SPSHT_OTHER', 'ISpRecoContext2', 'SpeechLexiconType',
    'ISpRecognizer3', 'DISPID_SBSRead', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPEDisplayText',
    'SGRSTTTextBuffer', 'ISpObjectWithToken', 'SVSFPurgeBeforeSpeak',
    'SPAS_STOP', 'DISPID_SPIElements', 'STSF_FlagCreate',
    ...
    'SECFDefault', 'SAFTADPCM_22kHzStereo', 'SpeechRecoContextState',
    'DISPID_SFSOpen', 'SPPARTOFSPEECH', 'DISPID_SRCEHypothesis',
    'DISPID_SPPParent', 'SRESoundEnd', 'DISPID_SRRSaveToMemory',
    'ISpeechLexiconPronunciation', 'eLEXTYPE_RESERVED8',
    'SRTAutopause', 'DISPID_SVEBookmark', 'SVSFVoiceMask',
    'SAFTADPCM_8kHzStereo', 'ISpeechRecoResult2', 'ISpXMLRecoResult',
    'ISpShortcut', 'DISPID_SpeechPhoneConverter',
    'SREFalseRecognition', 'SPCT_SUB_COMMAND',
    'DISPID_SPRuleFirstElement', 'SPRS_INACTIVE',
    'SAFTCCITT_ALaw_44kHzStereo', 'SRADynamic', 'SRAORetainAudio',
    'SPSERIALIZEDPHRASE', 'SPVPRI_ALERT',
    'DISPID_SpeechRecoResultTimes', 'ISpRecoResult',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SDKDeleteKey',
    'SAFT8kHz8BitStereo', 'ISpeechMemoryStream', 'SVSFUnusedFlags',
    ...
    'DISPID_SpeechRecoResult2', 'DISPID_SPEsCount', 'DISPID_SGRsAdd',
    'DISPID_SRCEAdaptation', 'DISPID_SpeechPhraseProperty',
    'DISPID_SpeechLexiconWords', 'DISPID_SPIEnginePrivateData',
    'SGSEnabled', 'DISPID_SPRulesCount', 'SpeechCategoryAppLexicons',
    'SP_VISEME_1', 'DISPID_SPACommit', 'DISPID_SGRsCount',
    'SPWORDLIST', 'SAFT11kHz8BitStereo', 'ISpPhoneConverter',
    'DISPID_SVEAudioLevel', 'eLEXTYPE_PRIVATE18', 'SP_VISEME_10',
    'SpeechCategoryRecoProfiles', 'DISPID_SPCLangId', 'SGDisplay',
    'SP_VISEME_9', 'SPWAVEFORMATTYPE', 'SpVoice', 'SPCATEGORYTYPE',
    'DISPID_SRGRules', 'SVSFIsFilename', 'DISPID_SLGetPronunciations',
    'DISPID_SRGCmdLoadFromMemory', 'eLEXTYPE_PRIVATE13',
    'DISPID_SVAudioOutputStream', 'SPRECOGNIZERSTATUS',
    'SREAudioLevel', 'ISpeechPhraseProperty', 'SPBO_TIME_UNITS',
    'SAFTDefault', 'ISpRecoGrammar', 'DISPID_SRRAlternates',
    'DISPID_SOTsItem', 'SpeechAudioFormatType', 'SPBO_PAUSE',
    'SASClosed', 'DISPID_SPARecoResult', 'SPAR_Medium',
    'SPEI_REQUEST_UI', 'ISpeechPhoneConverter', 'SAFT48kHz8BitMono',
    'DISPID_SGRSRule', 'SpStream', 'SPFM_CREATE',
    'ISpeechLexiconWord', 'SPWORD', 'SPEI_MAX_SR',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRCERecognition',
    'ISpeechGrammarRules', 'DISPID_SOTDataKey', 'SpeechRecoEvents',
    'SAFT44kHz8BitStereo', 'DISPID_SpeechLexicon',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRRecognizer',
    '_RemotableHandle', 'SPINTERFERENCE_TOOLOUD',
    'SpeechCategoryAudioIn', 'SpeechPropertyResourceUsage',
    'SpCompressedLexicon', 'DISPID_SVGetProfiles',
    'DISPID_SDKSetLongValue', 'DISPID_SWFESamplesPerSec',
    ...
    'SP_VISEME_15', 'eLEXTYPE_RESERVED7', 'DISPID_SpeechAudioFormat',
    'SAFT24kHz8BitMono', 'DISPID_SpeechGrammarRule', 'SVP_7',
    'SGDSInactive', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPPNumberOfElements', 'DISPID_SCSBaseStream',
    'DISPID_SLPLangId', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechRecognizerStatus', 'eLEXTYPE_USER',
    'DISPID_SPPsItem', 'SPLEXICONTYPE', 'SVP_1', 'DISPID_SGRSTsCount',
    'SpeechEmulationCompareFlags', 'SPEI_RESERVED2', 'SWTDeleted',
    'SDKLCurrentConfig', 'SPBINARYGRAMMAR', 'SGPronounciation',
    'ISpRecognizer', 'SPAR_Low', 'SpeechVoiceCategoryTTSRate',
    'SINone', 'DISPID_SOTsCount', 'SPCT_SUB_DICTATION', 'SVP_4',
    'STCInprocServer', 'DISPID_SVEStreamEnd',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpeechPhraseRules',
    'SPPS_RESERVED4', 'DISPID_SPPChildren', 'DISPID_SRAudioInput',
    'SWPUnknownWordPronounceable', 'DISPID_SVEEnginePrivate',
    'DISPID_SRSClsidEngine', 'SVSFParseSsml', 'SPRST_INACTIVE',
    'DISPID_SPPFirstElement', 'DISPID_SADefaultFormat',
    'SpCustomStream', 'SpeechGrammarTagUnlimitedDictation',
    'IInternetSecurityManager', 'DISPID_SVAudioOutput',
    'DISPID_SMSSetData', 'DISPID_SRSSupportedLanguages',
    'SpeechTokenKeyAttributes', 'DISPID_SPRsCount',
    'SRADefaultToActive', 'DISPID_SPIRule', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechCustomStream', 'DISPID_SpeechWaveFormatEx',
    'SPPHRASERULE', 'SpeechPartOfSpeech', 'SPSHT_Unknown',
    'ISpPhoneticAlphabetConverter', 'SVEAllEvents',
    'SpPhraseInfoBuilder', 'SAFTCCITT_uLaw_11kHzMono',
    'SVSFPersistXML', 'SRTStandard', 'DISPIDSPTSI_ActiveLength',
    'SLOStatic', 'SREPropertyStringChange', 'DISPID_SRGCommit',
    'SRERequestUI', 'DISPID_SPAsCount', 'DISPID_SVIsUISupported',
    'SSSPTRelativeToStart', 'SPEI_VOICE_CHANGE', 'SP_VISEME_19',
    'DISPID_SREmulateRecognition', 'eLEXTYPE_PRIVATE20',
    'eLEXTYPE_RESERVED10', 'SDTReplacement',
    'DISPID_SRCEventInterests', 'DISPID_SPISaveToMemory',
    'DISPID_SRGSetTextSelection', 'SDTAlternates',
    'DISPID_SGRAddResource', 'SVSFParseSapi',
    'SpeechRegistryUserRoot', 'SPEI_TTS_PRIVATE', 'STSF_LocalAppData',
    'SPPS_Function', 'eLEXTYPE_PRIVATE5', 'SVPNormal',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechPhraseInfo',
    'DISPID_SPEDisplayAttributes', 'DISPID_SVPause',
    'SpNotifyTranslator', 'DISPID_SOTDisplayUI', 'SPGRAMMARWORDTYPE',
    'Speech_StreamPos_Asap', 'SRSInactive', 'SRSActive', 'LONG_PTR',
    'SAFT24kHz16BitStereo', 'SDA_No_Trailing_Space',
    'SpeechBookmarkOptions', 'DISPID_SPEsItem', 'ISpPhraseAlt',
    'DISPID_SRGetRecognizers', 'DISPIDSPTSI',
    'DISPID_SRCVoicePurgeEvent', 'ISpeechAudio', 'ISpeechRecognizer',
    'DISPID_SVDisplayUI', 'DISPID_SVSkip',
    'SpeechPropertyNormalConfidenceThreshold', 'SP_VISEME_8',
    'SpeechTokenShellFolder', 'DISPID_SRRTStreamTime',
    'SVEAudioLevel', 'DISPID_SLPPhoneIds', 'SP_VISEME_3',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPIRetainedSizeBytes', 'SPGS_ENABLED',
    'DISPID_SRIsShared', 'ISpeechObjectTokenCategory',
    'DISPID_SVSVisemeId', 'SPEI_HYPOTHESIS', 'SpeechEngineConfidence',
    'DISPID_SMSALineId', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVWaitUntilDone', 'SAFT44kHz8BitMono',
    'DISPID_SRRRecoContext', 'SDTPronunciation',
    'DISPID_SpeechPhraseRules', 'DISPID_SLWLangId', 'DISPID_SVEWord',
    'SVSFDefault', 'SRAONone', 'SPSInterjection',
    'SDA_Two_Trailing_Spaces', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRGDictationUnload', 'SITooSlow',
    'DISPID_SOTMatchesAttributes', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechPhraseRule', 'eLEXTYPE_PRIVATE11', 'SVP_16',
    'DISPID_SLWPronunciations', 'SpeechDictationTopicSpelling',
    'DISPID_SDKCreateKey', 'SPEI_MIN_TTS',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRRAudioFormat',
    'SECFIgnoreCase', 'DISPID_SPEActualConfidence', 'DISPID_SPRsItem',
    'DISPID_SpeechMemoryStream', 'DISPID_SVSLastBookmark',
    ...
    'DISPID_SRCERequestUI', 'DISPID_SRDisplayUI', 'SpeechRunState',
    'SPEI_SENTENCE_BOUNDARY', 'ISpeechPhraseReplacements',
    'ISpeechPhraseRule', 'SPEI_WORD_BOUNDARY', 'SSFMCreateForWrite',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRCEEnginePrivate',
    'SVEPhoneme', 'DISPID_SpeechRecoContext', 'SAFT8kHz8BitMono',
    'SAFT32kHz16BitMono', 'ISpeechDataKey', 'SGDSActiveUserDelimited',
    'SpMMAudioEnum', 'SpeechGrammarState', 'SP_VISEME_0',
    'SPEI_PHRASE_START', 'DISPID_SAFType', 'SPVPRI_OVER',
    'SSFMOpenReadWrite', 'DISPID_SRCEPropertyStringChange',
    'SpeechStreamFileMode', 'SASRun', 'DISPID_SGRSTsItem',
    'DISPID_SPRuleId', 'tagSPPROPERTYINFO', 'DISPID_SGRInitialState',
    'SP_VISEME_13', 'SECNormalConfidence', 'DISPID_SRRPhraseInfo',
    'DISPID_SRRSetTextFeedback', 'ISpeechGrammarRuleStateTransitions',
    'SpeechTokenIdUserLexicon', 'SAFT32kHz16BitStereo',
    'DISPID_SGRName', 'SVP_6', 'SPRST_INACTIVE_WITH_PURGE',
    'SPSModifier', 'DISPID_SPPs_NewEnum', 'DISPID_SPIGrammarId',
    'SBONone', 'Speech_Default_Weight', 'SPINTERFERENCE_TOOQUIET',
    ...
    'SPPS_RESERVED3', 'DISPID_SRGCmdLoadFromObject', 'SPLOADOPTIONS',
    'SPINTERFERENCE_NOISE', '_SPAUDIOSTATE',
    'DISPID_SpeechPhraseReplacement', 'STCRemoteServer', 'SVF_None',
    'DISPID_SDKEnumKeys', 'DISPID_SVGetAudioInputs', 'SPEI_RESERVED3',
    'SpUnCompressedLexicon', 'STCAll', 'DISPID_SPILanguageId',
    ...
    'SAFTGSM610_22kHzMono', 'DISPID_SAEventHandle', 'SPSHORTCUTPAIR',
    'DISPID_SDKGetBinaryValue', 'SP_VISEME_2', 'SGSExclusive',
    'DISPID_SRSCurrentStreamNumber', 'SFTSREngine',
    '_ISpeechVoiceEvents', 'ISpPhoneticAlphabetSelection',
    'SPSHT_NotOverriden', 'DISPID_SPIProperties',
    'eLEXTYPE_RESERVED4', 'SPVOICESTATUS', 'SVEViseme',
    'DISPID_SPPsCount', 'DISPID_SRGDictationSetState',
    'DISPID_SRCEEndStream', 'SRATopLevel',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFT16kHz8BitStereo',
    'DISPID_SRCEInterference', 'SGRSTTWord', 'SPPHRASEELEMENT',
    'DISPID_SASState', 'DISPID_SRRAudio', 'DISPID_SPRuleParent',
    'DISPID_SRRSpeakAudio', 'STSF_AppData', 'SPBO_AHEAD',
    'DISPID_SGRsItem', 'DISPID_SRSAudioStatus', 'eLEXTYPE_PRIVATE16',
    'SpStreamFormatConverter', 'DISPID_SVSRunningState',
    'DISPIDSPTSI_SelectionLength', 'SpeechAllElements',
    ...
    'SAFTCCITT_ALaw_22kHzStereo', 'SVPOver', 'SAFT44kHz16BitStereo',
    'DISPID_SOTGetAttribute', 'DISPID_SLWWord', 'STSF_CommonAppData',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPERequiredConfidence',
    'SFTInput', 'SPCT_SLEEP', 'SpeechAudioFormatGUIDWave', 'UINT_PTR',
    'DISPID_SMSAMMHandle', 'DISPID_SVPriority',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'IEnumString', 'SPEI_MAX_TTS',
    'SRTExtendableParse', 'DISPID_SpeechVoiceStatus',
    'SPEI_PROPERTY_STRING_CHANGE', 'eLEXTYPE_PRIVATE7',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPCS_ENABLED',
    'SPSERIALIZEDRESULT', 'SVP_13', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SVSpeak', 'SPRS_ACTIVE', 'ISpProperties',
    'SpMemoryStream', 'DISPID_SRCEPropertyNumberChange',
    'SPEI_RECOGNITION', 'ISpStreamFormatConverter', 'DISPID_SOTCId',
    ...
    'tagSTATSTG', 'SPPROPERTYINFO', 'SPRST_NUM_STATES',
    'DISPID_SAFGuid', 'SPCS_DISABLED', 'DISPID_SpeechPhraseAlternate',
    'eWORDTYPE_ADDED', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SBSFormat', 'Speech_StreamPos_RealTime',
    'eLEXTYPE_PRIVATE14', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SOTCDefault', 'SVEEndInputStream',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SAFTText',
    'DISPID_SWFEBlockAlign', 'SVEPrivate', 'eLEXTYPE_RESERVED9',
    'DISPID_SDKEnumValues', 'SAFTCCITT_ALaw_11kHzMono',
    'SPEVENTSOURCEINFO', 'SGSDisabled', 'ISpPhrase',
    'ISpeechPhraseElements', 'ISpeechRecoGrammar', 'DISPID_SAStatus',
    'SPPHRASEREPLACEMENT', 'SREAdaptation', 'SPBO_NONE',
    'ISpeechAudioStatus', 'SWTAdded', 'SpeechRetainedAudioOptions',
    'SpeechGrammarWordType', 'SVP_9', 'ISpeechRecoResultDispatch',
    'DISPID_SGRsCommit', 'DISPID_SGRs_NewEnum', 'SRCS_Enabled',
    'SDTAll', 'SpInProcRecoContext', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRGReset', 'SPSSuppressWord',
    'DISPID_SLRemovePronunciation', 'SpWaveFormatEx',
    'SWPUnknownWordUnpronounceable', 'STCInprocHandler',
    'DISPID_SPEAudioSizeTime', 'SpSharedRecoContext',
    'SAFT48kHz8BitStereo', 'SpeechCategoryVoices',
    'DISPID_SPRuleConfidence', 'SPAO_NONE', 'SPPS_Unknown',
    'Speech_Max_Pron_Length', 'SSFMOpenForRead',
    'SpeechVoicePriority', 'SVP_3', 'SP_VISEME_4', 'SPVPRIORITY',
    'SPEVENTENUM', 'SPAUDIOSTATE', 'DISPID_SPAsItem',
    'DISPID_SWFEChannels', 'DISPID_SLGetGenerationChange', 'SVP_11',
    'DISPID_SRCEFalseRecognition', 'SpeechAudioState', 'SLODynamic',
    'SPEI_START_INPUT_STREAM', 'SPEI_END_SR_STREAM',
    'ISpeechObjectToken', 'SPWT_PRONUNCIATION', 'SPAR_High',
    'DISPID_SRCState', 'SITooFast', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRCESoundEnd', 'DISPID_SLPsCount', 'SRSActiveAlways',
    'ISpEventSink', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPPConfidence', 'SPFM_CREATE_ALWAYS',
    'DISPID_SPIReplacements', '_ISpeechRecoContextEvents', 'SVP_12',
    'SECFIgnoreWidth', 'SVP_18', 'SpAudioFormat',
    'SAFT22kHz16BitMono', 'SDTRule', 'DISPID_SRGCmdLoadFromResource',
    ...
    'DISPID_SPAs_NewEnum', 'SPGS_DISABLED', 'SRTEmulated', 'SLTUser',
    'SPPS_Interjection', 'DISPID_SPIGetText', 'ISpAudio',
    'DISPID_SVEViseme', 'SpMMAudioOut', 'SpeechInterference',
    'DISPID_SpeechVoice', 'SP_VISEME_18', 'SVP_2', 'SVSFlagsAsync',
    'SPRST_ACTIVE_ALWAYS', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRAudioInputStream', 'SVSFParseMask',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFT12kHz8BitMono', 'DISPID_SOTCGetDataKey',
    'DISPID_SGRSTransitions', 'SVP_14', 'SPEI_UNDEFINED',
    'SAFT11kHz16BitMono', 'DISPID_SGRSTText', 'eLEXTYPE_PRIVATE3',
    'ISpRecoCategory', 'SVSFIsXML', 'SPWORDPRONUNCIATION',
    'SpeechPropertyResponseSpeed', 'DISPID_SPPId',
    'SAFTGSM610_8kHzMono', 'SPAO_RETAIN_AUDIO', 'SP_VISEME_16',
    'DISPID_SRCRecognizer', 'SPINTERFERENCE_TOOSLOW',
    'SPXMLRESULTOPTIONS', 'SAFT12kHz8BitStereo', 'DISPID_SRRTimes',
    'ISpeechTextSelectionInformation', 'DISPID_SRCResume',
    'DISPID_SVSInputSentencePosition', 'SPSVerb', 'SSTTWildcard',
    'SECHighConfidence', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SABIEventBias', 'DISPID_SLPType', 'SRESoundStart',
    'SPRST_ACTIVE', 'SVEBookmark', 'SAFTGSM610_11kHzMono',
    'ISpNotifyTranslator', 'SP_VISEME_12', 'DISPID_SRStatus',
    'SAFT22kHz16BitStereo', 'DISPID_SOTGetDescription',
    'DISPID_SPIEngineId', 'eLEXTYPE_PRIVATE17', 'SPRULESTATE',
    'SPDKL_CurrentUser', 'SRTSMLTimeout',
    'DISPID_SRGSetWordSequenceData', 'ISpeechResourceLoader',
    'DISPID_SPRs_NewEnum', 'SVP_19', 'eWORDTYPE_DELETED',
    'SPSHT_EMAIL', 'DISPID_SOTSetId', 'ISpeechFileStream',
    'SpeechWordPronounceable', 'DISPID_SPEAudioTimeOffset',
    'SpeechGrammarTagDictation', 'SpMMAudioIn', 'SGRSTTWildcard',
    'DISPID_SpeechPhraseBuilder', 'SPEI_PHONEME',
    'SpeechAudioProperties', 'SPEI_SR_BOOKMARK', 'SDTLexicalForm',
    'SpeechVisemeType', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpObjectToken', 'DISPID_SWFEBitsPerSample',
    'SAFT32kHz8BitStereo', 'DISPID_SFSClose', 'SpResourceManager',
    'ISpSerializeState', 'DISPID_SRCERecognizerStateChange',
    'SPINTERFERENCE', 'ISpeechPhraseAlternate',
    'DISPID_SRGetPropertyNumber', 'SWPKnownWordPronounceable',
    'SPEI_TTS_BOOKMARK', 'DISPID_SVGetVoices', 'SECLowConfidence',
    'SPPS_Noncontent', 'DISPID_SRCPause', 'SPTEXTSELECTIONINFO',
    'DISPID_SPCPhoneToId', 'DISPID_SRGCmdSetRuleIdState',
    'SPEI_TTS_AUDIO_LEVEL', 'SPPS_NotOverriden',
    'IInternetSecurityMgrSite', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SpeechMMSysAudio', 'SPWF_INPUT', 'SPFM_OPEN_READWRITE',
    'SpeechRuleAttributes', 'SAFTCCITT_ALaw_8kHzMono', 'SGDSActive',
    'SPEI_MIN_SR', 'DISPID_SABIMinNotification',
    'DISPID_SGRsFindRule', 'SPXRO_Alternates_SML', 'SRSEDone',
    'Speech_Max_Word_Length', 'SVP_15', 'DISPID_SRGetPropertyString',
    'SP_VISEME_17', 'SpeechTokenKeyUI', 'DISPID_SRGDictationLoad',
    'SINoise', 'SPSMF_SAPI_PROPERTIES',
    ...
    'DISPID_SVEVoiceChange', 'SpeechPropertyAdaptationOn', 'SVP_10',
    'DISPID_SOTRemove', 'SPRULE', 'SPEI_FALSE_RECOGNITION',
    'SPWORDPRONOUNCEABLE', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRRDiscardResultInfo', 'SVP_21',
    'DISPID_SVSLastBookmarkId', 'SPFILEMODE', 'SpNullPhoneConverter',
    'ISpeechPhraseInfoBuilder', 'SREStateChange',
    'DISPID_SpeechPhraseAlternates', 'SAFTExtendedAudioFormat',
    'eLEXTYPE_APP', 'DISPID_SRSCurrentStreamPosition',
    'SVEVoiceChange', 'SAFTCCITT_ALaw_44kHzMono', 'SP_VISEME_5',
    'SPVISEMES', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRRTLength', 'SpTextSelectionInformation',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SVESentenceBoundary',
    'DISPID_SGRClear', 'DISPID_SRCAudioInInterferenceStatus',
    'SpSharedRecognizer', 'ISpLexicon', 'DISPID_SVEPhoneme',
    'SpeechEngineProperties', 'DISPID_SBSSeek', 'DISPID_SpeechAudio',
    'SpeechDataKeyLocation', 'DISPID_SPIStartTime',
    'SPSEMANTICFORMAT', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SGLexical', 'SpeechRecoProfileProperties', 'SpeechWordType',
    'DISPID_SVSInputWordLength', 'ISpeechRecoResultTimes',
    'ISpeechLexiconWords', 'SRCS_Disabled', 'SREStreamEnd',
    'DISPID_SpeechObjectTokenCategory', 'SVP_20', 'SpeechVoiceEvents',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpEventSource',
    'DISPID_SRCRetainedAudio', 'DISPID_SPAStartElementInResult',
    'SREHypothesis', 'SAFTADPCM_44kHzMono', 'SpeechDisplayAttributes',
    'DISPID_SABufferInfo', 'SSSPTRelativeToCurrentPosition',
    'SAFTADPCM_8kHzMono', 'SAFT24kHz16BitMono', 'SREAllEvents',
    'DISPID_SGRSTWeight', 'DISPID_SPIAudioStreamPosition',
    'ISpeechGrammarRule', 'SpPhoneticAlphabetConverter',
    'SpeechVoiceSkipTypeSentence', 'SRERecognition',
    'DISPID_SASFreeBufferSpace', 'DISPID_SVSInputWordPosition',
    'eLEXTYPE_PRIVATE1', 'SPSUnknown', 'DISPID_SLPs_NewEnum',
    'DISPID_SRGId', 'eLEXTYPE_PRIVATE8', 'SPEI_ADAPTATION',
    'DISPID_SWFEExtraData', 'SREPropertyNumChange',
    'SVEStartInputStream', '__MIDL_IWinTypes_0009', 'SDTProperty',
    'DISPID_SRCEPhraseStart', 'SPAS_PAUSE', 'DISPID_SOTs_NewEnum',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SSSPTRelativeToEnd',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SVGetAudioOutputs',
    'ISpeechBaseStream', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRGetFormat', 'SpShortcut', 'ISpDataKey', 'SpLexicon',
    'STCLocalServer', 'SREStreamStart', 'SDKLCurrentUser',
    'SDKLLocalMachine', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SPRuleName', 'DISPID_SGRSTPropertyId',
    'DISPID_SGRAddState', 'SPEI_RESERVED1', 'DISPID_SpeechRecoResult',
    'DISPID_SRRTTickCount', 'DISPID_SBSWrite', 'SPRECOSTATE',
    ...
    'eLEXTYPE_PRIVATE19', 'SITooQuiet', 'SPWT_DISPLAY',
    'DISPID_SGRsDynamic', 'DISPID_SVAlertBoundary',
    'DISPID_SRCBookmark', 'DISPID_SRGIsPronounceable',
    'SpeechCategoryAudioOut', 'ISpRecoContext', 'SPWF_SRENGINE',
    'ISpeechRecognizerStatus', 'SGRSTTDictation', 'SP_VISEME_20',
    'SRAInterpreter', 'DISPID_SLAddPronunciation', 'SASStop',
    'SVSFIsNotXML', 'SPCT_DICTATION', 'SpeechVisemeFeature',
    'SVPAlert', 'DISPID_SRRTOffsetFromStart', 'DISPID_SLWs_NewEnum',
    'SINoSignal', 'DISPID_SGRSTs_NewEnum', 'SREPrivate',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpRecognizer2', 'ISpNotifySource',
    'SAFT8kHz16BitStereo', 'IStream', 'SAFTADPCM_11kHzMono',
    'SDA_One_Trailing_Space', 'DISPID_SPRules_NewEnum',
    'SP_VISEME_21', 'SpeechTokenContext', 'DISPID_SVStatus',
    'DISPIDSPRG', 'DISPID_SVSInputSentenceLength',
    'eLEXTYPE_RESERVED6', 'SPVPRI_NORMAL', 'DISPID_SPPValue',
    'SPPS_Noun', 'SECFNoSpecialChars', 'SGRSTTRule',
    'SAFT11kHz8BitMono', 'SVF_Stressed', 'ISpStream',
    'SPDKL_DefaultLocation', 'SpeechUserTraining', 'DISPID_SRGState',
    'SPSLMA', 'SPEI_SR_RETAINEDAUDIO', 'DISPID_SpeechAudioStatus',
    'SPSMF_UPS', 'SPPS_Verb', 'SpeechStreamSeekPositionType',
    'SPCONTEXTSTATE', 'ISpeechGrammarRuleState', 'ISpeechLexicon',
    'DISPID_SLPsItem', 'DISPID_SAFGetWaveFormatEx',
    'SAFT12kHz16BitStereo', 'SVP_5', 'SRERecoOtherContext',
    'SPAUDIOSTATUS', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechPhraseElements', 'ISpeechAudioFormat',
    'SREPhraseStart', 'SPEVENT', 'DISPID_SpeechLexiconWord',
    'ISpeechRecoContext', 'DISPID_SGRSTRule', 'eLEXTYPE_PRIVATE4',
    'SP_VISEME_14', 'DISPID_SVVolume', 'ISpRecoGrammar2',
    'ISpResourceManager', 'ISpeechPhraseAlternates', 'DISPID_SVRate',
    'SAFT24kHz8BitStereo', 'SRSEIsSpeaking', 'SITooLoud',
    'DISPID_SpeechLexiconPronunciation', 'SVESentenceBoundary',
    'ISpeechPhraseInfo', 'SDKLDefaultLocation', 'DISPID_SRProfile',
    'eLEXTYPE_PRIVATE6', 'SAFTCCITT_uLaw_22kHzMono',
    'SVEWordBoundary', 'SPCT_COMMAND', 'SpeechVoiceSpeakFlags',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPRText', 'SPBOOKMARKOPTIONS',
    'SPEI_VISEME', 'SAFTCCITT_uLaw_8kHzMono', 'SPAUDIOOPTIONS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SVSpeakCompleteEvent', 'SAFT16kHz16BitMono', 'SPWORDTYPE',
    'DISPID_SVSPhonemeId', 'SPFM_NUM_MODES', 'SpeechTokenKeyFiles',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechGrammarTagWildcard',
    'SPEI_START_SR_STREAM', 'SPEI_SR_PRIVATE',
    'DISPID_SVEStreamStart', 'SPRECORESULTTIMES',
    'DISPID_SOTCEnumerateTokens', 'SpeechRecognitionType',
    'SAFT16kHz8BitMono', 'DISPID_SRGRecoContext',
    'DISPID_SVEventInterests', 'SP_VISEME_6', 'SpeechLoadOption',
    'DISPID_SGRSAddSpecialTransition', 'ISpeechCustomStream',
    'ISpeechPhraseReplacement', 'SP_VISEME_7', 'SPPS_SuppressWord',
    'SPAR_Unknown', 'DISPID_SPAPhraseInfo', 'DISPID_SPRuleChildren',
    'DISPIDSPTSI_SelectionOffset', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpStreamFormat', 'SRTReSent', 'SpeechTokenValueCLSID',
    'SPGS_EXCLUSIVE', 'ISequentialStream', 'ISpeechVoiceStatus',
    'ISpeechWaveFormatEx', 'SPLO_DYNAMIC', 'DISPID_SOTCategory',
    'eLEXTYPE_PRIVATE10', 'SpeechGrammarRuleStateTransitionType',
    'SpeechRecognizerState', 'DISPID_SOTId',
    'DISPID_SDKSetStringValue', 'ISpMMSysAudio',
    'DISPID_SRSetPropertyString', 'SPSNoun', 'SAFT22kHz8BitStereo',
    'SPEI_RESERVED6', 'DISPID_SRRGetXMLResult', 'SGRSTTEpsilon',
    'SAFT48kHz16BitMono', 'SPAS_CLOSED', 'SECFIgnoreKanaType',
    'SpInprocRecognizer', 'SPPHRASEPROPERTY',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPWT_LEXICAL',
    'DISPID_SpeechRecoContextEvents', 'WAVEFORMATEX', 'SPSFunction',
    'SpeechSpecialTransitionType', 'DISPID_SpeechDataKey',
    'SAFTCCITT_uLaw_11kHzStereo', 'SRARoot', 'DISPID_SRCEBookmark',
    'SLTApp', 'DISPID_SRState', 'DISPID_SPRuleNumberOfElements',
    'SP_VISEME_11', 'SVSFNLPMask', 'SAFT32kHz8BitMono',
    'DISPID_SLWsCount', 'DISPID_SPPEngineConfidence',
    'DISPID_SRSetPropertyNumber', 'SpObjectTokenCategory',
    ...
    'DISPID_SPRFirstElement', 'SPSHORTCUTTYPE', 'SPDKL_LocalMachine',
    'SVP_8', 'ISpeechPhraseElement', 'DISPID_SLGetWords',
    'DISPID_SLWType', 'SPDKL_CurrentConfig', 'SAFTGSM610_44kHzMono',
    'DISPID_SPIAudioSizeBytes', 'SPSEMANTICERRORINFO', 'SVF_Emphasis',
    'SVP_0', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SGRSTType', 'SPFM_OPEN_READONLY', 'SpFileStream',
    'ISpGrammarBuilder', 'SAFTNonStandardFormat', 'SASPause',
    'SAFT8kHz16BitMono', 'SRSInactiveWithPurge',
    'DISPID_SGRAttributes', 'SpeechRuleState',
    ...
    'SAFTADPCM_11kHzStereo', 'SPEI_RECO_OTHER_CONTEXT',
    'SPPS_RESERVED1', 'eLEXTYPE_VENDORLEXICON', 'SPXRO_SML',
    'SRAImport', 'DISPID_SPEs_NewEnum',
    'DISPID_SASCurrentSeekPosition', 'SpeechDiscardType'
]

_check_version('1.2.0', 1698726792.803982)
